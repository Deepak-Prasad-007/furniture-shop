...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1><a href="index.html">BOOKING  REPORT<span></span> </a></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
...
$result=mysql_query("select * from booking",$db);
while($row = mysql_fetch_Array($result))
{
 ?>
  <tr>
  <td><a href="admin_edit_booking.php?id=<?php echo $row[0]?>">Edit</a></td>    
