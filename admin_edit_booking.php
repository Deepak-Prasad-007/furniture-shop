...
mysql_query("update booking set bdate='$t2',f_t='$t3',f_p='$t4',c_n='$t5',address='$t6',phone='$t7' where bid=$t1",$db);
mysql_close();
header("location: admin_report_booking.php");
$GLOBALS["msg"]="<span style='color:yellow'>* Booking Detail Updated sucessfully..</span>";
}
    ...
    mysql_select_db("furniture",$db);
    $id=$_GET["id"];
    $result=mysql_query("select * from booking where bid='$id'",$db);
